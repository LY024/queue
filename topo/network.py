...
net.setP4Source('s176', 'p4/multimodel_queue.p4')
net.setP4CliInput('s176', 'tables/s176-commands.txt')
net.setPriorityQueueNum('s176', 8)

net.addP4Switch('s178')
net.setP4Source('s178', 'p4/multimodel_queue.p4')
net.setP4CliInput('s178', 'tables/s178-commands.txt')
net.setPriorityQueueNum('s178', 8)

net.addP4Switch('s182')
net.setP4Source('s182', 'p4/multimodel_queue.p4')
net.setP4CliInput('s182', 'tables/s182-commands.txt')
net.setPriorityQueueNum('s182', 8)

net.addP4Switch('s184')
net.setP4Source('s184', 'p4/multimodel_queue.p4')
net.setP4CliInput('s184', 'tables/s184-commands.txt')
net.setPriorityQueueNum('s184', 8)

net.addP4Switch('s186')
net.setP4Source('s186', 'p4/multimodel_queue.p4')
net.setP4CliInput('s186', 'tables/s186-commands.txt')
net.setPriorityQueueNum('s186', 8)

net.addP4Switch('s188')
net.setP4Source('s188', 'p4/multimodel_queue.p4') 
net.setP4CliInput('s188', 'tables/s188-commands.txt')
net.setPriorityQueueNum('s188', 8)
#------------------------------------------
#net.addLink('h162', 's182', 0, 1, None, intfName1='', intfName2='', addr1='', addr2='')
net.addLink('h162', 's182', 0, 1)
net.addLink('h164', 's184', 0, 1)
net.addLink('h166', 's186', 0, 1)
net.addLink('h168', 's188', 0, 1)
net.addLink('h170', 's176', 0, 4)
net.addLink('h172', 's176', 0, 1)
net.addLink('h174', 's178', 0, 1)
net.addLink('h180', 's178', 0, 4)

net.addLink('s176', 's182', 2, 5, bw = 30)
net.addLink('s176', 's186', 3, 2, bw = 30)
net.addLink('s178', 's184', 2, 2, bw = 30)
net.addLink('s178', 's188', 3, 5, bw = 30)
net.addLink('s182', 's184', 2, 5, bw = 30)
net.addLink('s182', 's186', 4, 3, bw = 30)
net.addLink('s182', 's188', 3, 3, bw = 30)
net.addLink('s184', 's186', 4, 4, bw = 30)
net.addLink('s184', 's188', 3, 4, bw = 30)
net.addLink('s186', 's188', 5, 2, bw = 30)
#------------------------------------------
net.setIntfMac('h162', 's182', 'e8:61:1f:37:b6:d3')
net.setIntfMac('s182', 'h162', 'a0:36:9f:ed:55:63')
...
net.setIntfMac('s182', 's176', 'a0:36:9f:ed:5c:63')
net.setIntfMac('s176', 's186', 'a0:36:9f:08:d1:2a')
net.setIntfMac('s186', 's176', 'a0:36:9f:a8:5c:bb')
net.setIntfMac('s178', 'h180', 'a0:36:9f:08:c7:b7')
net.setIntfMac('h180', 's178', 'e8:61:1f:37:b5:8b')
net.setIntfMac('s178', 's184', 'a0:36:9f:08:c7:b5')
...
net.setIntfMac('s182', 's184', 'a0:36:9f:ed:5c:60')
net.setIntfMac('s184', 's182', 'a0:36:9f:d9:3b:18')
net.setIntfMac('s182', 's186', 'a0:36:9f:ed:5c:61')
net.setIntfMac('s186', 's182', 'a0:36:9f:a8:5c:b9')
net.setIntfMac('s182', 's188', 'a0:36:9f:ed:5c:62')
